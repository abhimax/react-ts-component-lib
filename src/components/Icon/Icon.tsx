...
const Icon: React.FC<IconProps> = ({ name, size = 24, color = "#ff0000" }) => {
  return (
    <div className="icon-wrapper" style={{ width: size }}>
      {icons[name]}
    </div>
  );
};
...
const icons = {
  cross: (
    <svg xmlns="http://www.w3.org/2000/svg" fill={color} viewBox="0 0 94 94">
      <path
